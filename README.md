...
| Monte Carlo Tree Search with Boltzmann Exploration <br> [NeurIPS link - Short Video & Abstract](https://neurips.cc/virtual/2023/poster/71873) <br> _I have been doing some work in MCTS since the days of AlphaGO. I still have some code and a beautiful go board with exotic stones_| [Poster](https://neurips.cc/media/PosterPDFs/NeurIPS%202023/71873.png?t=1702041264.953116) | [Paper](https://openreview.net/forum?id=NG4DaApavi) <br> [Slides](https://neurips.cc/media/neurips-2023/Slides/71873.pdf)| |
| | | |
***
***
